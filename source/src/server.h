...
guninfo guns[NUMGUNS] =
{
    ...
    { "shotgun", "V-19 CS",      S_SHOTGUN, S_RSHOTGUN, 2400,   80,    1,    0,     0,   0,  1,   35,    7,   9,  9,  10, 140,  140,   125,  1,   true },   // CAUTION dmg only sane for server!
    { "subgun",  "A-ARD/10 SMG", S_SUBGUN,  S_RSUBGUN,  1650,   40,     16,   0,     0,   0, 45,   15,   60,   1,  2,   5,  25,   50,   188,  1,   true  },
